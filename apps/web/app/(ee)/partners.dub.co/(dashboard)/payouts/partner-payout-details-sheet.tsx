        ...
        ? [
            {
              ...
              value: (
                <Tooltip
                  content={[
                    payout.method === "stablecoin" &&
                      `Stablecoin payouts on Mifily are subject to a [${STABLECOIN_PAYOUT_FEE_RATE * 100}% transaction fee](https://dub.co/help/article/receiving-payouts#connecting-a-stablecoin-wallet).`,
                    payout.amount < MIN_WITHDRAWAL_AMOUNT_CENTS &&
