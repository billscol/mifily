...
// this variant is for handling cases where there are paid commissions via Mifily – in this case we need to create a dummy commission to represent the overpayment + a clawback to balance the books
async function main() {
